    ...
    public void iniciarPreparacion() {
        ...
        if (orden != null && !orden.isVacia()) {
            ...
            for (Producto producto : orden.getProductos()) {
                System.out.println("Preparando: " + producto.getInfoTicket());
                producto.preparar(); 
                System.out.println("--------------------");
            }
            ...
            System.out.println("AVISO: No hay nada en la orden para preparar. Añade productos primero.");
